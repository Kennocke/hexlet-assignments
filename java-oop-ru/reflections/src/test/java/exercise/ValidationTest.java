...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address1 = new Address("Russia", "Ufa", null, "54", null);
        Map<String, List<String>> result1 = Validator.advancedValidate(address1);
        Map<String, List<String>> expected1 = Map.of("street", List.of("can not be null", "length less than 5"));
        assertThat(result1).isEqualTo(expected1);

        Address address2 = new Address("Russia", "Ufa", "Lenina", "54", "3");
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of();
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("Russia", null, "Len", "54", null);
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("city", List.of("can not be null"), "street", List.of("length less than 5"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
