...
class AppTest {
    ...
    void reversedSequenceTest() {
        ReversedSequence result = new ReversedSequence("Pasta");

        String expected1 = "atsaP";
        assertThat(result.toString()).isEqualTo(expected1);

        char expected2 = 't';
        assertThat(result.charAt(1)).isEqualTo(expected2);

        String expected3 = "tsa";
        assertThat(result.subSequence(1, 4)).isEqualTo(expected3);
    }
    // END
}
